...
toph = plot3(topo_trj{1}(1,:), topo_trj{1}(2,:), topo_trj{1}(3,:), 'Color', [164 0 6 32]/255, 'LineStyle', ':', 'LineWidth', 2);%拓扑连线
scth = scatter3(X(1,:,1), X(2,:,1), X(3,:,1), 250, 'MarkerEdgeColor', 'none', 'MarkerFaceColor', [164 0 6]/255, 'MarkerFaceAlpha', .9);%'MarkerFaceColor', 'none');%实际值
refh = scatter3(H(1,:,1), H(2,:,1), H(3,:,1), 100, 'MarkerEdgeColor', 'none', 'MarkerFaceColor', [164 0 6]/255, 'MarkerFaceAlpha', .25);%设定值
